...
/* harmony import */ var _components_animate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/animate */ "./src/js/components/animate.js");
/* harmony import */ var _components_animate__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_animate__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_animate_ticker__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/animate-ticker */ "./src/js/components/animate-ticker.js");
/* harmony import */ var _components_animate_ticker__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_animate_ticker__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _components_numberCounter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/numberCounter */ "./src/js/components/numberCounter.js");
/* harmony import */ var _components_numberCounter__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_components_numberCounter__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var _vendor_graph_accordion_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./vendor/graph-accordion.js */ "./src/js/vendor/graph-accordion.js");
...
const accordion3 = new _vendor_graph_accordion_js__WEBPACK_IMPORTED_MODULE_0__["default"]('.accordion-3', {
  speed: 700
});
const accordion4 = new _vendor_graph_accordion_js__WEBPACK_IMPORTED_MODULE_0__["default"]('.accordion-4', {
  speed: 700
});
const accordion5 = new _vendor_graph_accordion_js__WEBPACK_IMPORTED_MODULE_0__["default"]('.accordion-5', {
  speed: 700
});
const accordion6 = new _vendor_graph_accordion_js__WEBPACK_IMPORTED_MODULE_0__["default"]('.accordion-6', {
  speed: 700
});
const accordion7 = new _vendor_graph_accordion_js__WEBPACK_IMPORTED_MODULE_0__["default"]('.accordion-7', {
  speed: 700
});
const accordion8 = new _vendor_graph_accordion_js__WEBPACK_IMPORTED_MODULE_0__["default"]('.accordion-8', {
  speed: 700
});

/***/ }),

/***/ "./src/js/components/animate-ticker.js":
/*!*********************************************!*\
  !*** ./src/js/components/animate-ticker.js ***!
  \*********************************************/
/***/ (() => {
...
document.addEventListener('DOMContentLoaded', () => {
  // Анимация ticker с помощью библиотеки GSAP (Greensock)
  gsap.registerPlugin(ScrollTrigger); // Подключения плагина ScrollTrigger
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const chatArr = [{
    ...
    textAdmin: 'Понимаю, это может вызывать тревогу. А какие мысли приходят вам в голову, когда вы думаете о предстоящем рабочем дне?'
  }, {
    img: 'img/avatar-2.png',
    textUser: 'Я не умею заводить друзей...',
    textAdmin: 'Поделитесь, пожалуйста, что именно вас беспокоит в процессе знакомства? Какие эмоции вы при этом испытываете?'
  }, {
    img: 'img/avatar-3.png',
    textUser: 'Я никому не нужен...',
    textAdmin: 'Это может быть очень тяжелым ощущением. Если вы не возражаете, расскажите, какие обстоятельства привели вас к такой мысли?'
  }, {
    img: 'img/avatar-4.png',
    textUser: 'Уже давно у меня нет отношений...',
    textAdmin: 'Не могли бы вы поделиться, как вы думаете, всегда ли прошлый опыт определяет наше будущее?'
  }, {
    img: 'img/avatar-5.png',
    textUser: 'Наверное, я что-то делаю не так...',
    textAdmin: 'Как вы считаете, что именно могло пойти не так? Есть ли конкретные моменты, которые вызывают у вас такие мысли?'
  }];
  ...
  function getChat(chat) {
    ...
    chatAdmin.classList.add('chat__message', 'chat__admin', 'animate__animated', 'animate__fadeIn', 'animate__delay-3s', 'animate__slow');
  ...
  // heroRight.append(getChat(chatArr[0]));
...
/***/ "./src/js/components/numberCounter.js":
/*!********************************************!*\
  !*** ./src/js/components/numberCounter.js ***!
  \********************************************/
/***/ (() => {
...
const outNum = (n, num) => {
  const l = document.querySelector('#numberCounter');
  const step = 1;
  function randomInt() {
    n += step;
    let interval = setTimeout(() => {
      l.innerHTML = n.toLocaleString('ru');
      randomInt();
...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.ourAssistance__sliders', {
  slidesPerView: 1,
  spaceBetween: 50,
  grabCursor: true,
  speed: 500,
  ...
  navigation: {
    nextEl: '.ourAssistance__slider-btn--next',
    prevEl: '.ourAssistance__slider-btn--prev'
  },
  breakpoints: {
    576: {
      slidesPerView: 1.5
